...
Keep `robots.txt` and `sitemap.xml` in the repository root. They are already
configured for `https://masterkit.it.com/`. In Google Search Console, submit
`https://masterkit.it.com/sitemap.xml` after publishing this update.
